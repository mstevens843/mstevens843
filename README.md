...
I built and launched **[Agentic](https://agentic-signer.com)** and **[SolPulse](https://solpulse.trade)**: two production products across web, iOS, and Android with **2,250+ users**, **66 reviews**, 4.2★–4.3★ ratings, and live App Store, Google Play, and Solana dApp Store releases.
...
- **Traction** — 1,250+ users in 2 months, 4.2★ rating, 40 reviews.
